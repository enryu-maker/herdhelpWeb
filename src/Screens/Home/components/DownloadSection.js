  ...
  return (
    <div className='flex max-md:flex-col justify-center items-center py-24 gap-20 max-md:w-full'>
      <div className="flex flex-col justify-center items-center text-center">
        ...
        <button style={{
          fontFamily: "Poppins-Bold"
        }} className='flex justify-center items-center gap-5 bg-[#39B54A] text-2xl font-semibold w-[369px] h-[78px] rounded-full'>Download App <img src={arrowright} alt="" className='w-[30px]' /></button>
      </div>
